...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Azure Kinect")
		static void SetColorTexture(UTextureRenderTarget2D* texture);

	UFUNCTION(BlueprintCallable, Category = "Azure Kinect")
		static void SetDepthTexture(UTextureRenderTarget2D* texture);

	UFUNCTION(BlueprintCallable, Category = "Azure Kinect")
		static void SetInflaredTexture(UTextureRenderTarget2D* texture);
